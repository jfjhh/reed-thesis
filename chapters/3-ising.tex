...
\begin{proof}
  Note that the list $E(K)$ of all energies (with duplicates) may be used to
  define an empirical cumulative distribution function (\textsc{ecdf}). For
  example, if instead $E(k_i) = i$, then
\end{proof}
