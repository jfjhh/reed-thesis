...
Hamiltonian $\ham_S$ to $\ham_{LS}$.\footnote{%
  One may then diagonalize $\gamma_{\alpha\beta}$ to put \cref{eq:microlindblad}
  into the standard form of \cref{eq:lindblad}. In our example
  $\gamma_{\alpha\beta}$ will already be diagonal.
}
